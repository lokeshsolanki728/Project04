...
<body>
	...
	<form action="${ctx}${ORSView.FORGET_PASSWORD_CTL}" method="post">
		<div class="container">
			...
			<p class="text-center">Submit your Email address to reset your
				password.</p>

			<%@ include file="message.jsp"%>

			<div class="input-container">
				<input type="hidden" name="id"> <label for="login">Email
					<span class="required">*</span>
				</label> <input type="text" id="login" name="login"
					placeholder="Enter Email Address" value="${bean.login}"
					class="form-control"> <span class="error-message"></span>
			</div>
