...
public class MarksheetModel extends BaseModel {
    ...
    public long add(MarksheetDTO dto) throws ApplicationException, DuplicateRecordException {
        ...
        try {
            ...
            if (studentbean == null) {
                throw new ApplicationException("Exception: Student not found with ID " + dto.getStudentld());
            }
            ...
            JDBCDataSource.trnRollback(conn); // Rollback transaction
            ...
            throw e; // Re-throw the DuplicateRecordException
        }
        catch(Exception e){
    ...
    public void update(MarksheetDTO dto) throws ApplicationException, DuplicateRecordException {
        ...
        MarksheetDTO beanExist = findByRollNo(dto.getRollNo());
        ...
        try {
            ...
            try (ResultSet rs = pstmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    list.add(resultBean.getMarksheetBean());
                }
            }
        } }catch (SQLException e) {
