...
public class CourseModel {
    ...
    public void update(CourseBean bean) throws ApplicationException, DuplicateRecordException {
        ...
        try {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement("UPDATE ST_COURSE SET NAME=?, DESCRIPTION=?, DURATION=?, MODIFIED_BY=?, MODIFIED_DATETIME=? WHERE ID=?")) {              
    ...
    private Integer nextPK() throws DatabaseException {
        ...
        try {
            conn = JDBCDataSource.getConnection();
            try(PreparedStatement pstmt = conn.prepareStatement("SELECT MAX(ID) FROM ST_COURSE");
                ResultSet rs = pstmt.executeQuery();){
                if (rs.next()) {
                    pk = rs.getInt(1);
                }
    ...
    public List list(int pageNo, int pageSize) throws ApplicationException {
     ...
     private CourseBean fillBean(ResultSet rs) throws Exception{
